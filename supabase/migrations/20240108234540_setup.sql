...
AS $$
DECLARE
  project_url TEXT := 'https://okxjlaajslvnhzsxmubx.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9reGpsYWFqc2x2bmh6c3htdWJ4Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcyMTY3ODY2NSwiZXhwIjoyMDM3MjU0NjY1fQ.50N-ynehKvauC8naWiGQhAanA-OpT7fpz_t-6VGUKs0'; -- full access needed for http request to storage
